    ...
    <View style={styles.container}>
      ...
      <View >
        <View style={{paddingTop : 20}}>
            <View style={styles.selectDiv}>
                ...
                <View style={{display : 'flex', flexDirection :'row', gap : 5, alignItems : 'center'}}>
                    ...
                    <Text style={{fontFamily : 'Railway3', color : Colors.myRyGreen, fontSize : 15}}>Bank Card</Text>
                </View>
        ...
        <View style={styles.bottomBtns} >
            <TouchableOpacity style={styles.eachBottomBtn} onPress={()=>{navigate.navigate('auth/order_status')}}>
